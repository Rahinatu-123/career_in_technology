    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'add':
                ...
                if (!empty($name) && !empty($short_quote) && !empty($full_story)) {
                    // Start transaction
                    $conn->begin_transaction();
                    
                    try {
                        // Insert story
                        $stmt = $conn->prepare("INSERT INTO inspiring_stories (name, role, company, short_quote, full_story) VALUES (?, ?, ?, ?, ?)");
                        $stmt->bind_param("sssss", $name, $role, $company, $short_quote, $full_story);
                        $stmt->execute();
                    ...
                    $error_message = "Name, short quote, and full story are required fields.";
                }
                break;
                ...
                <form method="POST" action="">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="short_quote" name="short_quote" rows="3" required></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="full_story" class="form-label">Full Story</label>
                            <textarea class="form-control" id="full_story" name="full_story" rows="5" required></textarea>
                        </div>
                        <div class="mb-3">
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="short_quote<?php echo $story['id']; ?>" class="form-label">Short Quote</label>
                            <textarea class="form-control" id="short_quote<?php echo $story['id']; ?>" name="short_quote" rows="3" required><?php echo htmlspecialchars($story['short_quote']); ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="full_story<?php echo $story['id']; ?>" class="form-label">Full Story</label>
                            <textarea class="form-control" id="full_story<?php echo $story['id']; ?>" name="full_story" rows="5" required><?php echo htmlspecialchars($story['full_story']); ?></textarea>
                        </div>
                        <div class="mb-3">
